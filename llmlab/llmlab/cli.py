...
def cmd_harness(args) -> int:
    ...
    print(wrap("Each file carries a header recording the input, the "
               ...
               "header is the difference between rung four and rung one."))
    print()
    return 0
...
def build_parser() -> argparse.ArgumentParser:
    ...
    common.add_argument("--model", default=None, help="model name, e.g. gemma:latest")
    ...
    s = sub.add_parser("harness", parents=[common],
                       help="apply one specification to a folder of inputs")
