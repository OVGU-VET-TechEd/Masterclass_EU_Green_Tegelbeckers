# References — Workshop 4: AI in Teaching (v5)

EduGreenLabs / OvGU Magdeburg — WP2 Training Lab, EU GREEN Alliance.
Licensed CC BY 4.0. Compiled September 2026.

Everything cited in `masterclass_ai_in_teaching_v5.html` and
`workshop4_ai_in_teaching_v5.md`, grouped by what you would need it for.
Sources added in version 4 come largely from the reading list circulated in the
OvGU working group on AI and digitality in study and teaching.

Links were checked at the time of writing. Where an item is unpublished or has
no stable link, that is stated rather than papered over.

**If you want three things and nothing else:** Ferdman on deskilling as a
structural problem, the Wissenschaftsrat recommendations for the German frame,
and Chandra and colleagues on why warning somebody about sycophancy does not
...
## A note on the unpublished draft

HETAICF v0.11 is used in Appendix A of both deliverables for its *structure*
only. It is an unpublished draft under review, its numbering will change, and its
competence identifiers carry no authority. Do not cite them — including in your
own teaching materials. The transferable part is the mechanism: take a published
framework, find where its addressee differs from yours, and write down only the
difference.
