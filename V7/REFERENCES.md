# References — Workshop 4: AI in Teaching (v7)

EduGreenLabs / OvGU Magdeburg — WP2 Training Lab, EU GREEN Alliance.
Licensed CC BY 4.0. Compiled September 2026.

Everything cited in `masterclass_ai_in_teaching_v7_labs.html` and
`workshop4_ai_in_teaching_v7.md`, grouped by what you would need it for.
...
1. UNESCO-UNEVOC / ASSET Co-initiative, OvGU (2026). *Self-learning nuggets: AI Orientation, AI Basics, AI Tools, Prompting, Quality and Ethics.* Five LiaScript modules written for TVET teachers, recommended as a self-study route into the basics.
